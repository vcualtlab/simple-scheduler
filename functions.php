  ...
  <div id="comment-<?php comment_ID(); ?>" <?php comment_class('cf'); ?>>
    <article  class="cf">
      <header class="comment-author vcard">
        Claimed by <?php echo get_comment_author(); ?> on <time datetime="<?php echo comment_time('Y-m-j'); ?>"><?php comment_time(__( 'F jS, Y', 'bonestheme' )); ?></time>
      </header>
      <?php if ($comment->comment_approved == '0') : ?>
        <div class="alert alert-info">
          <p><?php _e( 'Your claim is awaiting moderation.', 'bonestheme' ) ?></p>
        </div>
      <?php endif; ?>
    </article>
...
// @todo: the walker below is the key to a waitlist. Gotta tweak it and make it work.
	...
	class comment_walker extends Walker_Comment {
		...
		// start_lvl â€“ wrapper for child comments list
		...
		// end_lvl â€“ closing wrapper for child comments list
		...
		// start_el â€“ HTML for comment template
		function start_el( &$output, $comment, $depth, $args, $id = 0 ) {
			...
			<article <?php comment_class(empty( $args['has_children'] ) ? '' :'parent') ?> id="comment-<?php comment_ID() ?>" itemscope itemtype="http://schema.org/Comment">
				<figure class="gravatar"><?php echo get_avatar( $comment, 65, '[default gravatar URL]', 'Authorâ€™s gravatar' ); ?></figure>
